function desplazamientoDemanda = desplazamientoDemandaConsumoCombustibles(pais)
    switch pais
        case "USA"
            ...
            grid on
            title('Proyección Desplazamiento Consumo de Combustibles US 2018 - 2030')
            xlabel('año')
            ...
            saveas(gcf, 'fig/California/ProyeccionDesplazamientoCombustibles-US.png') 
        ...
        case "Chile"
            ...
            grid on
            title('Proyección Desplazamiento Consumo de Combustibles Chile 2018 - 2030')
            xlabel('año')
            ylabel('Millones de BoE')
            ...
            saveas(gcf, 'fig/Chile/ProyeccionDesplazamientoCombustibles-Chile.png') 
        ...
        case "Canada"
            ...
            grid on
            title('Proyección Desplazamiento Consumo de Combustibles Canadá 2018 - 2030')
            xlabel('año')
            ylabel('Millones de BoE')
            ...
            saveas(gcf, 'fig/Canada/ProyeccionDesplazamientoCombustibles-Canada.png')
        ...
        case "Holanda"
            ...
            grid on
            title('Proyección Desplazamiento Consumo de Combustibles Holanda 2018 - 2030')
            xlabel('año')
            ylabel('Millones de BoE')
            ...
            saveas(gcf, 'fig/Holanda/ProyeccionDesplazamientoCombustibles-Holanda.png')
